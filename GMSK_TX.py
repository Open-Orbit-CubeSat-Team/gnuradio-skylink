...
class GMSK_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 437.125e6
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL,pmt.init_u8vector(5, [104, 101, 108, 108, 111])), 1000)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.digital_gmsk_mod_0, 0))
